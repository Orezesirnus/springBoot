...
public class AuthorizationHeaderFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
    ...
    if (Boolean.TRUE.equals(this.jwtUtils.validateToken(jwtToken))) {
      ...
      SecurityContextHolder.getContext().setAuthentication(authToken);    //contenitore di sping security: si occupa di fare il controllo e metterlo ne contesto come già autenticato
    }
